			...
			<c:forEach items="${dto.replydtolist }" var="replydto">
				<form class="frm-rreply">
					...
					<input type="hidden" name="boardReplyId"
						value="${replydto.boardReplyId }"> <input type="hidden"
						name="boardReplyLevel" value="${replydto.boardReplyLevel }">
					<input type="hidden" name="boardReplyStep"
						value="${replydto.boardReplyStep }"> <input type="hidden"
						name="boardReplyRef" value="${replydto.boardReplyRef }">
